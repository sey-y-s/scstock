...
export default function Show({ auth, packagingType, products }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title={`Emballage - ${packagingType.name}`} />

            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    {/* En-tête du type d'emballage */}
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-6">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <h1 className="text-2xl font-bold text-gray-900">{packagingType.name}</h1>
                            ...
                            {packagingType.description && (
                                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                                    ...
                                    <p className="text-gray-900">{packagingType.description}</p>
                                </div>
                            )}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 text-center">
                                    ...
                                    <div className="text-sm text-orange-600">Produits total</div>
                                </div>
                                ...
                                <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                                    ...
                                    <div className="text-sm text-red-600">Produits en rupture</div>
                                </div>
                            </div>
                        </div>
                    </div>

                    {/* Produits avec ce type d'emballage */}
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 border-b border-gray-200">
                            <div className="flex justify-between items-center">
                                <h2 className="text-xl font-bold text-gray-900">
                                    📦 Produits avec cet emballage
                                </h2>
                        ...
                        {products.data.length === 0 ? (
                            <div className="p-12 text-center text-gray-500">
                                ...
                                <p className="text-lg mb-2">Aucun produit avec ce type d'emballage</p>
